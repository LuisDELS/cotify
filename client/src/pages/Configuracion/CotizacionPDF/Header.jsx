...
export default function Header({ logoUrl, companyName, companyRut, companyAddress, companyEmail, title, cotizationNumber, clientName, clientRut, clientAddress, clientEmail, clientPhone }) {
